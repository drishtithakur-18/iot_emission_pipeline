...
Stress-tested using **Autocannon** with the initial burst throughput exceeding 64k requests/10s. Across repeated runs, throughput ranged between 50k-64k requests/10s depending on local CPU and disk I/O availability.
